...
local buf_keymap = vim.api.nvim_set_keymap
...
local on_attach = function(_, bufnr)
  ...
  -- vim.keymap.set(bufnr, 'n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>')
  vim.keymap.set('n', 'gr', ':Telescope lsp_references<CR>')

  -- vim.keymap.set(bufnr, 'n', '<leader>ca', '<cmd>lua vim.lsp.buf.code_action()<CR>')
  -- vim.keymap.set(bufnr, 'v', '<leader>ca', '<cmd>lua vim.lsp.buf.range_code_action()<CR>')
  -- vim.keymap.set(bufnr, 'n', '<leader>ca', ':Telescope lsp_code_actions<CR>')
  -- vim.keymap.set(bufnr, 'v', '<leader>ca', ':Telescope lsp_range_code_actions<CR>')
